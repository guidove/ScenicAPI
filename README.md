...
`https://scenicapp.spaces/Scenic/api/import/<endpointname>?<parameter1name>=<parameters1value&<parameters2name>=<parameter2value>&...etc.`
- Endpoint names are `gpxurl`, `polyline` and `coordinates
- It's important that all parameter values are urlencoded
- If you use GET requests from another iOS app you need to include the parametername `fromOtherApp` with parametersvalue `1`
